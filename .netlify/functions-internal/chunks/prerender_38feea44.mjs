...
const $$idmos = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$6, $$props, $$slots);
  Astro2.self = $$idmos;
  console.log(Astro2.params);
  const { idmos } = Astro2.params;
  return renderTemplate`${maybeRenderHead()}<section><h1>Pokemones</h1><p>${idmos}</p></section>`;
}, "C:/xampp/htdocs/practicas-astro-js/src/pages/detallePoke/[idmos].astro", void 0);

const $$file$3 = "C:/xampp/htdocs/practicas-astro-js/src/pages/detallePoke/[idmos].astro";
const $$url$3 = "/detallePoke/[idmos]";

const _idmos_ = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
    __proto__: null,
    default: $$idmos,
    file: $$file$3,
    url: $$url$3
...
export { _idmos_ as _, _id_ as a, _01Posts as b, _02Posts as c, dibujos as d, _01Mark as e, _02Mark as f, _03Mark as g, _404 as h, index as i };
