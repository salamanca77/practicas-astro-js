...
const $$Nosotros = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Nosotros", "data-astro-cid-noeej2nj": true }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<section data-astro-cid-noeej2nj><h1 data-astro-cid-noeej2nj>Motivacion disciplina y practica </h1></section>` })}`;
