...
const $$file = "C:/xampp/htdocs/practicas-astro-js/src/pages/detallePersonaje/[id].astro";
const $$url = "/detallePersonaje/[id]";
...
export { $$Header as $, _id_ as _, apiconeccion as a, $$Layout as b };
